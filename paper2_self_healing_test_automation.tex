...
\bibitem{javvadi2025healing_dataset} V.~P.~Javvadi, ``AI-Driven Self-Healing Test Automation Dataset: DOM Snapshots, Mutation Pipeline, Healing Logs, and Trained Models,'' Zenodo, 2025. DOI: \href{https://doi.org/10.5281/zenodo.19684439}{10.5281/zenodo.19684439}.

\end{thebibliography}

\section*{Data Availability}

The experimental dataset, mutation pipeline scripts, DOM snapshot corpus, healing event logs, and trained Random Forest ranking model used in this study are publicly available on Zenodo~\cite{javvadi2025healing_dataset}: \url{https://doi.org/10.5281/zenodo.19684439}. The release includes all 1,600 experiment rows, per-mutation-class breakdowns, and the full five-version application corpus, enabling complete independent replication of all results reported in this paper.
